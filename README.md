...
| **blaquebaux-basket** | exchange / swap funds — hidden private-wealth vehicles | **analytical study done** — all providers are Reg D private placements (democratized $1M/QP → $100k/accredited via Cache, still private). No alpha (fund = target index − fee); the product **is** the capital-gains deferral, conditional (marginal on liquidation; **+5–22% after-tax hold-to-death** via the step-up, for high-embedded-gain holders, break-even fee ~1.8%); diversification is free to anyone who sells. A tax/estate vehicle, not a strategy |
