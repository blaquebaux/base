...
REPO="/Users/malcolmx/Downloads/Blaque Baux and Crypto Quant/blaque_baux_canonical"
...
# 2) trading-day gate (pre-open): the next market open (ET) must be TODAY, else it's a
#    weekend/holiday — skip. (Idempotency also protects us, but this avoids noise.)
